...
import com.buiders.shabaz.R;

public class Shabaz extends Activity {
public int number=0;
byte     	    buffer[];
    ...
    public String About(){
        ...
        about.setTitle(R.string.app_name)
             // .setIcon(R.drawable.dialog_icon)
               .setMessage("This app was build during my exam time it might buggy bcoz it was made lot of anxiety!! So bear wit me...!")
               .setCancelable(true)
    ...
    public boolean parse (String config_file) {
    	...
    	if (!file.exists()) {
    		if (config_file != LIRCD_CONF_FILE)
    			Toast.makeText(getApplicationContext(), "The Selected file is not there", Toast.LENGTH_SHORT).show();
    		else
    			Toast.makeText(getApplicationContext(), "Not working, update database", Toast.LENGTH_SHORT).show();
    		//selectFile();
    		return false;
    	}
...
return false;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
    	...
    	case 2:
    	//selectFile();
    		Intent myIntent = new Intent(Shabaz.this, Iconic.class);
